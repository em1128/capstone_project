                ...
                if (num_bodies == num_bodies2 && num_bodies != 0) {
                    ...
                    for (size_t i_body = 0; i_body < num_bodies; i_body++)
                    {
                      ...
                      /*  Drawing_marker(skeleton, i_body, new_pset, sensor_calibration, xy_color, p_set_2D, body_frame, colorMat, color_image, color_buffer, colors0);*/
                        ...
                        Drawing_marker(skeleton2, 0, fusion_pset, sensor_calibration2, xy_color2, p_set_2D2, body_frame2, colorMat2, color_image2, color_buffer2, colors);
                    ...
                    //816 joint saving, rod vector comparing
                            ...
                            if ((motion_clk + 1) % motion_frames_limit[motion_index] == 0 && frame_count) {
                                ...
                                while (!fs.eof()) {
                                    ...
                                    if (cnt % 3 == 0) {
                                        ...
                                        ans_vector[(cnt / 3 / 25) % motion_frames_limit_ans[motion_index]][(cnt / 3) % 25][0] = x;
                                        // for test dtw
                    ...
                    //if (frame_count < 77) {
                    //    putText(colorMat, instruction[0], Point(640, 80), FONT_ITALIC, 1, (255, 0, 0), 5);
                    //}
                    //else {
                    //    putText(colorMat, instruction[1], Point(640, 80), FONT_ITALIC, 1, (255, 0, 0), 5);
                    //}
                    //putText(colorMat, "10 points", Point(640, 50), FONT_ITALIC, 1, (255, 0, 0), 5);
